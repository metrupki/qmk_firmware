...
[_QWERTY] = LAYOUT_planck_grid(
    ...
    KC_PSCR, KC_LCTL, KC_LALT, KC_LALT, LOWER,   KC_LCTL, KC_SPC,  RAISE,   KC_ENT,  KC_RALT, KC_RCTL, KC_RGUI
),
...
[_RAISE] = LAYOUT_planck_grid(
    ...
    KC_DEL,  KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT,  KC_F5,   KC_F6,   KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, KC_BSLS,
    _______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_HASH, KC_NUBS, KC_PGUP, KC_PGDN, _______,
    _______, _______, _______, _______, _______, _______, _______, _______, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY
),
